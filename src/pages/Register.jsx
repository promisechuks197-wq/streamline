    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-dark-950 px-4 py-12">
      ...
      >
        <div className="text-center mb-8">
          ...
          <h2 className="text-3xl font-display font-bold mt-6 mb-2">Create Account</h2>
          <p className="text-dark-500">Join the StreamLined community</p>
        </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <label className="flex items-start gap-3 cursor-pointer">
              <input
                ...
                className="w-4 h-4 mt-0.5 rounded border-dark-300 text-brand-500 focus:ring-brand-500"
              />
